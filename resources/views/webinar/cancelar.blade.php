...
<div class="container"  >
  <p style="color: white; font-size:300%; text-align: center;">¡Hola {{$persona[0]->name}}!</p>
   <div align="center" style="color: white; font-size: 300%; text-align: center;">Estás a punto de cancelar la suscripción.
</div> 
  @php
           setlocale(LC_TIME, 'es_MX.UTF-8');
           $fecha = strftime("%d %b %Y", strtotime($persona[0]->fecha));
           $persona[0]->fecha = $fecha; 
   @endphp

 <!--<p style="color: white; font-size:300%; text-align: center;">{{$persona[0]->nombre}}</p>
 <p style="color: white; font-size:200%; text-align: center;">{{$persona[0]->fecha}}</p>
 <p style="color: white; font-size:200%; text-align: center;">{!!$persona[0]->descripcion!!}</p>-->
   <!--   <div align="center" style="color: white; font-size: 300%; text-align: center;">Estas a punto de cancelar la suscripción a los webinar de innovatium.
        {{$persona[0]->fecha}}
</div>  -->

<!--<p ">{{$persona[0]->descripcion}}</p>-->

<!--<p style="color: white; font-size:200%; text-align: center;"><b>correo: </b>{{$persona[0]->email}}</p>-->



  <form action="{{url('actualizar', $persona[0]->idRegistro)}}" method="POST" class="needs-validation" novalidate>
                               {{csrf_field()}}
                        {{method_field('PUT')}}
                        
                        <input type="hidden" value="" name="modificationBy"/>
                    

           
@foreach($persona as $p)
                          <div class="form-group row" style="display: none;">
                            <label for="inputDescuento" class="col-sm-2 col-form-label" style="color: white">Estado<b style="color: red;">*</b></label>
                            <div class="col-sm-10">
                             <textarea class="area" required name="inputInactivo" id="inputInactivo"  style="height: 90%">{{$p->estado}}</textarea>
...
<br>
                        <div class="form-group row" align="center">
                            <button type="submit" class="m-2 btn btn-primary">Cancelar suscripción</button>
...
<!--<div align="center"><a class="btn btn-info"  href="">cancelar</a></div>-->

          </div> 
          @else
          <p style="color: white; font-size:300%; text-align: center;">Tu suscripción fue cancelada.</p>
          <br><br><br><br><br><br>
@endif    
<br><br><br><br><br><br>
