...
<h1 style="margin-top: -2%;padding: 0px;">Eventos In Company Realizados</h1>
...
@php $currentPrivateEvent = '' @endphp
...
@php
           ...
           $e->start_date = $start_date;
            @endphp
    @if($e->eventsprivate_id != $currentPrivateEvent)
    ...
    <div style="line-height: 28px;">
            ...
            @php $currentPrivateEvent = $e->eventsprivate_id @endphp
<div style="line-height: 28px;">
            ...
            <div style="line-height: 28px;">
              <label class="linea" style=" color:black;padding: 0px; ">Cliente:</label>
               <p class="linea" style="color:black; display: inline;font-weight: 400;padding: 0px;">{{$e->client}}</p>
            </div>
            <div style="line-height: 28px;">
